...
final class TournamentLocationCell: UITableViewCell {
    ...
    let mapPreviewImageView = UIImageView()
    let imageKeyPortrait: String
    let imageKeyLandscape: String
    let latitude: Double
    ...
    private func setupCell() {
        ...
        mapPreviewImageView.setEdgeConstraints(top: contentView.topAnchor,
