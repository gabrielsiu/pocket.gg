...
final class PhaseGroupListViewController: UITableViewController {
    ...
    private func loadPhaseDetails() {
        ...
        NetworkService.getNumPhaseGroupsInBracket(id: id) { [weak self] (result) in
            guard let numPhaseGroups = result else {
                self?.doneRequest = true
            ...
            self?.phase.numPhaseGroups = numPhaseGroups
            NetworkService.getPhaseDetailsById(id: id, numPhaseGroups: numPhaseGroups) { (details) in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            cell.detailTextLabel?.text = "hi hand"
            return cell
        case 1:
